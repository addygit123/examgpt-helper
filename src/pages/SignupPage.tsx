  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <div className="w-full max-w-sm">
        ...
        <button className="w-full rounded-lg border border-border py-2.5 text-sm font-medium text-foreground btn-press hover:bg-muted animate-brand flex items-center justify-center gap-2 mb-4">
        ...
        <form onSubmit={handleSubmit} className="space-y-3">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full rounded-lg bg-primary py-2.5 text-sm font-medium text-primary-foreground btn-press shadow-surface disabled:opacity-50"
          >
